...
internal fun AppCompatActivity.setInflaterFactory(li: LayoutInflater, inflationDelegate: InflationDelegate?) =
  setFactory2(li, InflationInterceptor(this, inflationDelegate))
